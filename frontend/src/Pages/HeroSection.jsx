  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto flex flex-col gap-12">
        ...
        {/* Left Column: Heading + Highlights + Services */}
        <div className="flex flex-col md:flex-row items-start justify-between gap-12">
          ...
          {/* Right: Highlight / Subtext */}
          <div ref={highlightsRef} className="flex-1 pt-14 flex flex-col gap-6 md:mt-0 mt-6">
        ...
        <div ref={servicesRef} className="flex flex-col md:flex-row gap-3 items-center md:items-start mt-6">
          ...
          <p className="text-gray-500 text-sm sm:text-base max-w-2xl mx-auto md:mx-0 mt-4 md:mt-0">
              At KK Construction, we combine cutting-edge design, expert engineering, and precise execution
              to create structures that stand the test of time.    </p>
        </div>
       ...
       {!imageLoaded && (
          ...
          {/* Stats Box */}
          <div ref={statsRef} className="bg-[#ff6726] text-white p-6 sm:p-8 rounded-2xl shadow-lg w-full md:w-1/3 space-y-4 md:-mt-10 opacity-0 translate-y-8 transition-all duration-700 reveal">
            <div>
              <p className="text-3xl sm:text-4xl font-bold">
                <AnimatedCounter to={640} />+
              </p>
              <p className="text-xs sm:text-sm uppercase tracking-wide">Projects Completed</p>
            </div>
            <div>
              <p className="text-3xl sm:text-4xl font-bold">
                <AnimatedCounter to={25} />+
              </p>
              <p className="text-xs sm:text-sm uppercase tracking-wide">Years of Experience</p>
            </div>
            <div>
              <p className="text-3xl sm:text-4xl font-bold">
                <AnimatedCounter to={450} />+
